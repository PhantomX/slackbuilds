...
patch -p1 -E --backup --verbose -d mozilla -i ${SB_PATCHDIR}/mozilla-858919-2.patch
patch -p1 -E --backup --verbose -d mozilla -i ${SB_PATCHDIR}/mozilla-858919-3.patch
patch -p1 -E --backup --verbose -d mozilla -i ${SB_PATCHDIR}/mozilla-1042889.patch
