...
zcat ${SB_PATCHDIR}/sudo-1.7.1-libtool.patch.gz | patch -p1 -E --backup --verbose
# getgrouplist() to determine group membership (#235915)
patch -p1 -E --backup -z .getgrouplist --verbose -i ${SB_PATCHDIR}/sudo-1.7.2p4-getgrouplist.patch 
