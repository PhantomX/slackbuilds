...
zcat ${SB_PATCHDIR}/${NAME}-utils-oui-usage.patch.gz | patch -p0 -E --backup --verbose
...
patch -p1 -E --backup --verbose -i ${SB_PATCHDIR}/0001-Add-sixaxis-cable-pairing-plugin.patch
