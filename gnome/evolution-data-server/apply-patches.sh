...
# RH bug #202309
zcat ${SB_PATCHDIR}/${NAME}-1.7.91-maybe-fix-crash.patch.gz | patch -p1 -E --backup --verbose || exit 1
...
zcat ${SB_PATCHDIR}/${NAME}-2.22.0-implicit-function-declaration.patch.gz | patch -p1 -E --backup --verbose || exit 1
# GNOME bug #530323
zcat ${SB_PATCHDIR}/${NAME}-2.22.1-double-free.patch.gz | patch -p1 -E --backup --verbose || exit 1
