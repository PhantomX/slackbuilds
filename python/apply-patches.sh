...
zcat ${SB_PATCHDIR}/python-2.6-update-bsddb3-4.8.patch.gz | patch -p1 -E --backup --verbose
...
zcat ${SB_PATCHDIR}/python-2.6-ctypes-noexecmem.patch.gz | patch -p1 -E --backup --verbose
