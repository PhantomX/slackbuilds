...
patch -p1 -E --backup --verbose -i ${SB_PATCHDIR}/tmux-1.0-02_fix_wrong_location.diff
patch -p1 -E --backup --verbose -i ${SB_PATCHDIR}/tmux-1.0-03_proper_socket_handling.diff
# 2010-03-28: Submitted upstream:
# https://sourceforge.net/tracker/?func=detail&aid=2977950&group_id=200378&atid=973264
patch -p1 -E --backup --verbose -i ${SB_PATCHDIR}/tmux-1.0-04_dropping_unnecessary_privileges.diff
# 2010-03-28: Submitted upstream:
