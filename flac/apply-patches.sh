...
zcat ${SB_PATCHDIR}/${NAME}-1.2.1-gcc43.patch.gz | patch -p1 -E --backup --verbose || exit 1
...
zcat ${SB_PATCHDIR}/${NAME}-1.2.1-bitreader.patch.gz | patch -p0 -E --backup --verbose || exit 1
