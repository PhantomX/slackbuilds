...
# Build changes
#zcat ${SB_PATCHDIR}/${NAME}-0.9.8j-redhat.patch.gz | patch -p1 -E --backup --verbose || exit 1
...
#zcat ${SB_PATCHDIR}/${NAME}-0.9.8j-soversion.patch.gz | patch -p1 -E --backup --verbose || exit 1
#zcat ${SB_PATCHDIR}/${NAME}-0.9.8j-enginesdir.patch.gz | patch -p1 -E --backup --verbose || exit 1
...
#zcat ${SB_PATCHDIR}/${NAME}-0.9.8j-shlib-version.patch.gz | patch -p1 -E --backup --verbose || exit 1

# Bug fixes
zcat ${SB_PATCHDIR}/${NAME}-0.9.8b-aliasing-bug.patch.gz | patch -p1 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}-0.9.8k-x509-name-cmp.patch.gz | patch -p1 -E --backup --verbose || exit 1
...
#zcat ${SB_PATCHDIR}/${NAME}-0.9.8g-ia64.patch.gz | patch -p1 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}-0.9.6-x509.patch.gz | patch -p1 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}-0.9.8j-version-add-engines.patch.gz | patch -p1 -E --backup --verbose || exit 1
