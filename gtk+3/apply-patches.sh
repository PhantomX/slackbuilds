...
patch -p1 -R --backup --verbose -i ${SB_PATCHDIR}/gtk+3-3.18.0-gtk-recent-files-limit.patch
...
patch -p1 --backup --verbose -i ${SB_PATCHDIR}/gtk+3-3.18.0-disable-overlay.patch
