...
patch -p1 -E --backup --verbose -i ${SB_PATCHDIR}/wine-1.7.2-osmesa-check.patch
...
filterdiff -p1 -x configure -z ${SB_PATCHDIR}/wine-pulse-1.7.0.patch | patch -p1 -E --backup --verbose
