...
A nice example string to use: fluxbox-xdg-menu.py --with-icons --with-backgrounds --bg-path=~/some/path
To update only the backgrounds: fluxbox-xdg-menu.py--bg-path=~/some/path --backgrounds-only
"""
...
def footer(wm="fluxbox"):
	...
	[submenu] (Fluxbox Menu)
		...
		[submenu] (Tools)
			...
			[exec] (Run) {fbrun -nearmouse}
			[exec] (Regen Menu) {fluxbox-xdg-menu.py --with-icons}
		[end]
		[submenu] (Window)
