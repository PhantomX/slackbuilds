...
zcat ${SB_PATCHDIR}/attr-2.4.43-leak.patch.gz | patch -p1 --verbose --backup --suffix=.orig
...
patch -p1 -E --backup --verbose -i ${SB_PATCHDIR}/attr-2.4.44-bz587516.patch
# getfattr: encode NULs properly with --encoding=text (#650539)
patch -p1 -E --backup --verbose -i ${SB_PATCHDIR}/attr-2.4.44-bz650539.patch
