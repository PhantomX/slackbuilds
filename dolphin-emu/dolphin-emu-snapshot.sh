...
pushd "${tmp}"
  ...
  pushd ${module}-${snap}
    ...
    pushd Externals
      rm -rf Cg* GLew gettext libiconv-* libjpeg libpng libusb* LZO mbedtls miniupnpc msvcrt OpenAL polarssl portaudio Qt SDL* SFML SOIL soundtouch wxWidgets3 XAudio2* zlib
    popd >/dev/null
