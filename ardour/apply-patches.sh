...
zcat ${SB_PATCHDIR}/${NAME}-2.8-SConstruct.patch.gz | patch -p1 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}-2.8-session.cc-no_stomp.patch.gz | patch -p1 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}-2.8-gcc44.patch.gz | patch -p1 -E --backup --verbose || exit 1
