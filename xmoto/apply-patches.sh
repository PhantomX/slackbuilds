...
#zcat ${SB_PATCHDIR}/${NAME}-0.5.0-Scene-collisioninclude.patch.gz | patch -p0 -E --backup --verbose || exit 1
...
zcat ${SB_PATCHDIR}/${NAME}-0.4.2-opengldepth.patch.gz | patch -p0 -E --backup --verbose || exit 1
