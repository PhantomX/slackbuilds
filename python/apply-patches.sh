...
zcat ${SB_PATCHDIR}/disable-pymalloc-on-valgrind-py26.patch.gz | patch -p0 -E --backup --verbose || exit 1
...
zcat ${SB_PATCHDIR}/python-2.6-update-bsddb3-4.8.patch.gz | patch -p1 -E --backup --verbose || exit 1
# ...and a further patch to setup.py so that it searches for 4.8:
zcat ${SB_PATCHDIR}/python-2.6.4-setup-db48-slk.patch.gz | patch -p1 -E --backup --verbose || exit 1
