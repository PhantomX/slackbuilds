...
zcat ${SB_PATCHDIR}/vim-7.0-fixkeys.patch.gz | patch -p1 --verbose || exit 1
zcat ${SB_PATCHDIR}/vim-6.2-specsyntax.patch.gz | patch -p1 --verbose || exit 1
zcat ${SB_PATCHDIR}/vim-7.0-crv.patch.gz | patch -p1 --verbose || exit 1
zcat ${SB_PATCHDIR}/xxd-locale.patch.gz | patch -p1 --verbose || exit 1
if [ "${SB_HUNSPELL}" = "YES" ] ;then
  zcat ${SB_PATCHDIR}/vim-7.0-hunspell.patch.gz | patch -p1 --verbose || exit 1
fi
...
zcat ${SB_PATCHDIR}/vim-7.0-syntax.patch.gz | patch -p1 --verbose || exit 1
zcat ${SB_PATCHDIR}/vim-7.1-nowarnings.patch.gz | patch -p1 --verbose || exit 1
zcat ${SB_PATCHDIR}/vim-6.1-rh3.patch.gz | patch -p1 --verbose || exit 1
