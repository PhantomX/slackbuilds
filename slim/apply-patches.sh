...
zcat ${SB_PATCHDIR}/${NAME}-1.3.1-remove.patch.gz | patch -p1 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}-1.3.1-curdir.patch.gz | patch -p1 -E --backup --verbose || exit 1
