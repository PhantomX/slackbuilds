...
zcat ${SB_PATCHDIR}/${NAME}-1.1.15-buffer_h_ansi.patch.gz | patch -p1 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}-1.1.15-ffmpeg.patch.gz | patch -p1 -E --backup --verbose || exit 1
