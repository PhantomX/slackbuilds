...
zcat ${SB_PATCHDIR}/util-linux-ng-2.14-ipcs-32bit.patch.gz | patch -p1 -E --backup --verbose || exit 1
# remove partitions
zcat ${SB_PATCHDIR}/util-linux-ng-2.14-blockdev-rmpart.patch.gz | patch -p1 -E --backup --verbose || exit 1
