...
zcat ${SB_PATCHDIR}/${NAME}-4.2.0-ogg-mime-type.patch.gz | patch -p0 -E --backup --verbose
...
zcat ${SB_PATCHDIR}/${NAME}-4.3.80-fix-gstreamer-pulseaudio-deadlock.patch.gz | patch -p1 -E --backup --verbose
# http://bugs.kde.org/223662
zcat ${SB_PATCHDIR}/${NAME}-4.3.80-fix-xine-pulseaudio-init.patch.gz | patch -p1 -E --backup --verbose
# https://bugs.kde.org/213710
zcat ${SB_PATCHDIR}/${NAME}-4.4-subtitles-files-phonon-xine.patch.gz | patch -p1 -E --backup --verbose
