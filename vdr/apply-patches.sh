...
[ "${SNAPBUILD}" = "YES" ] || patch -p1 -E --backup --verbose -i ${SB_PATCHDIR}/vdr-2.0.6-filetransfer.patch
...
[ "${SNAPBUILD}" = "YES" ] || patch -p1 -E --backup --verbose -i ${DOWNDIR}/${EPSRCARCHIVE07}
...
zcat ${DOWNDIR}/${EPSRCARCHIVE10} | patch -p1 -E --backup --verbose
