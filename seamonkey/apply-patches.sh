...
patch -p1 -E --backup --verbose -d mozilla -i ${SB_PATCHDIR}/firefox-32-rhbz-966424.patch
patch -p1 -E --backup --verbose -d mozilla -i ${SB_PATCHDIR}/firefox-32-mozilla-858919.patch
case "${ARCH}" in
  i[3-6]86)
    patch -p2 -E --backup --verbose -d mozilla -i ${SB_PATCHDIR}/firefox-32-baseline-disable.patch
    ;;
esac
