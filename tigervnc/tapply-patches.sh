...
zcat ${SB_PATCHDIR}/${NAME}10-rh499401.patch.gz | patch -p0 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}10-rh497592.patch.gz | patch -p1 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}10-rh501832.patch.gz | patch -p1 -E --backup --verbose || exit 1
