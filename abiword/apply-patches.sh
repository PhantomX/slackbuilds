...
zcat ${SB_PATCHDIR}/${NAME}-2.6.4-desktop.patch.gz | patch -p1 -E --backup --verbose || exit 1
...
( cd ${SRCDIR2} || exit 1
  ...
  zcat ${SB_PATCHDIR}/${NAME}-plugins-2.6.8-rindex.patch.gz | patch -p1 -E --backup --verbose || exit 1
) || exit 1
