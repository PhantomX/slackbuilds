...
zcat ${SB_PATCHDIR}/${NAME}-2.19.50.0.1-linkonce-r-discard.patch.gz | patch -p0 -E --backup --verbose || exit 1
zcat ${SB_PATCHDIR}/${NAME}-2.19.50.0.1-gcc_except_table.patch.gz | patch -p0 -E --backup --verbose || exit 1
